              ...
              <div class="s_product_text">
                ...
                <div class="card_area d-flex justify-content-between align-items-center">
                  <div class="product_count">
                    <span class="inumber-decrement"> <i class="fa-solid fa-minus"></i></span>
                  ...
                  <form class="row contact_form" action="contact_process.php" method="post" id="contactForm"
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <input style="height: 35px; color: black;" type="text" class="form-control" id="name" name="name" placeholder="Your Full name" />
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <input style="height: 35px; color: black;" type="email" class="form-control" id="email" name="email" placeholder="Email Address" />
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <input style="height: 35px; color: black;" type="text" class="form-control" id="number" name="number" placeholder="Phone Number" />
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea style="height: 125px; color: black;" class="form-control" name="message" id="message" rows="1"
                      ...
                      <ul class="list">
                        <li>
                          <a href="#">5 Star
                            ...
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i> 01</a>
                        </li>
                        <li>
                          <a href="#">4 Star
                            ...
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa-regular fa-star"></i> 01</a>
                        </li>
                        <li>
                          <a href="#">3 Star
                            <i class="fa fa-star"></i>
              ...
              <div class="col-lg-6">
                <div class="review_box">
                  ...
                  <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                    <div class="col-md-12">
                      <div class="form-group">
                        <input style="height: 35px; color: black;" type="text" class="form-control" name="name" placeholder="Your Full name" />
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <input style="height: 35px; color: black;" type="email" class="form-control" name="email" placeholder="Email Address" />
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <input style="height: 35px; color: black;" type="text" class="form-control" name="number" placeholder="Phone Number" />
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea style="height: 125px; color: black;" class="form-control" name="message" rows="1" placeholder="Review"></textarea>
                      </div>
                    </div>
                    <div class="col-md-12 text-right">
                      <button type="submit" value="submit" class="btn_3">
