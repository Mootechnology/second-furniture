                    ...
                    <div class="card mb-xl-8 mb-5" style="user-select: auto;">
                        ...
                        <div class="card-header border-0 pt-5" style="user-select: auto;">
                            <h3 class="card-title align-items-start flex-column" style="user-select: auto;">
                                <span class="card-label fw-bold fs-3 mb-1" style="user-select: auto;">Add Color Pallet</span>
                            </h3>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                        <div class="card-body pt-3" style="user-select: auto;">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <x-cento-dash-input type="text" name="name" label=" Color Name" placeholder="Color Name" required
                            ...
                            <div class="modal-footer mt-5 gap-2">
                                <x-cento-dash-input type="submit" label="Add Color Pallet" />
                                <a class="btn btn-danger" href={{ route('color.index') }}> Cancel </a>
                            </div>
                            <!--end::Table container-->
                        </div>
                        <!--begin::Body-->
