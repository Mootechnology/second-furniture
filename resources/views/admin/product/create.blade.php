                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <x-cento-dash-input type="number" name="price" label="price"
                                            placeholder="price" :message="$errors->first('price')" required />
                                    </div>
                                    <div class="col-6">
                                        <x-cento-dash-input type="number" name="discounted_price"
                                            label="Discounted Price" placeholder="Discounted Price" :message="$errors->first('discounted_price')" />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <label class="col-lg-12 col-form-label required fw-bold fs-6"> Select Parent
                                            Category
                                        </label>
                                        <select name="parent_category_id" class="form-select form-select-solid is-valid"
                                            data-allow-clear="true" data-control="select2" id="parent">
                                    ...
                                    <div class="col-6">
                                        <label class="col-lg-12 col-form-label required fw-bold fs-6"> Select Child
                                            Category
                                        </label>
                                        <x-cento-dash-input type="select" id="child-dropdown" name="child_category_id"
                                            label="" :options="$childCategories" :message="$errors->first('child_category_id')" />
                                    </div>

                                    <div class="col-6">
                                        <x-cento-dash-input type="text" nullable name="sku"
                                            label="SKU (Unique Product No.)" placeholder="Produfct No. should be unique"
                                    ...
                                    <div class="col-6">
                                        <x-cento-dash-input type="number" name="product_weight"
                                            label="Product Weight" placeholder="product_weight" :message="$errors->first('product_weight')" />
                                    </div>
                                    <div class="col-6">
                                        <x-cento-dash-input type="number" name="product_height"
                                            label="Product Height" placeholder="product_height" :message="$errors->first('product_height')" />
                                    </div>
                                    <div class="col-6">
