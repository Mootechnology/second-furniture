            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                {{Request::route()->getName()=='sub.category.edit'?'hover show':''}}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{Request::route()->getName()=='parent.category.index'?'active':''}}{{Request::route()->getName()=='parent.category.create'?'active':''}}{{Request::route()->getName()=='parent.category.edit'?'active':''}}" href="{{ route('parent.category.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{Request::route()->getName()=='child.category.index'?'active':''}}{{Request::route()->getName()=='child.category.create'?'active':''}}{{Request::route()->getName()=='child.category.edit'?'active':''}}" href="{{ route('child.category.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-item menu-accordion ">
                        <!--begin:Menu link-->
                        <a class="menu-link {{Request::route()->getName()=='product.edit'?'active':''}}{{Request::route()->getName()=='product.create'?'active':''}}{{Request::route()->getName()=='product.index'?'active':''}}" href="{{ route('product.index') }}">
                            <span class="menu-bullet">
                                <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-item menu-accordion ">
                        <!--begin:Menu link-->
                        <a class="menu-link {{Request::route()->getName()=='blog.edit'?'active':''}}{{Request::route()->getName()=='blog.create'?'active':''}}{{Request::route()->getName()=='blog.index'?'active':''}}" href="{{ route('blog.index') }}">
                            <span class="menu-bullet"><span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
